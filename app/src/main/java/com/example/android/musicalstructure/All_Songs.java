    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeIntent = new Intent(All_Songs.this, MainActivity.class);
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nowPlayingIntent = new Intent(All_Songs.this, NowPlaying.class);
        ...
        purchaseSongs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent purchaseSongsIntent = new Intent(All_Songs.this, PurchaseSongs.class);
